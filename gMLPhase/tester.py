...
def tester(input_hdf5=None,
    ...
    model = gMLPmodel.load_from_checkpoint(checkpoint_path=os.path.join(args['output_name'],args['input_model']),hparams_file=os.path.join(args['output_name'],args['hparams_file']))
